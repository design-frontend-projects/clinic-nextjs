...
export const NAV_ITEMS: NavItem[] = [
  ...
  {
    titleKey: "sidebar.clinicDefinition",
    href: "/admin/clinics",
    iconKey: "clinic",
    roles: ["admin", "owner"],
  },
  ...
  {
    titleKey: "sidebar.myAppointments",
    href: "/doctor/appointments",
    iconKey: "appointments",
    roles: ["owner"],
  },
  {
    titleKey: "sidebar.labOrders",
    href: "/doctor/lab-orders",
    iconKey: "labOrders",
    roles: ["owner"],
  },
  {
    titleKey: "sidebar.myReviews",
    href: "/doctor/reviews",
    iconKey: "reviews",
    roles: ["owner"],
  },
  ...
  },
  {
    ...
    iconKey: "audit",
    roles: ["admin", "owner", "app_owner"],
    requiredPermission: "settings.audit.read",
  },
  {
    titleKey: "sidebar.notifications",
    href: "/settings/notifications",
    iconKey: "notifications",
    roles: ["admin", "owner", "doctor", "staff", "pharmacist"],
  },
