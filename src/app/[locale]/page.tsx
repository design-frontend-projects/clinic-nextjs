        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center gap-4">
            {!session ? (
              <>
                <Link href="/sign-in">
                  <Button variant="ghost" className="text-[#a8a8a8] hover:text-white hover:bg-[#181818] text-sm">
                    Sign In
                  </Button>
                </Link>
                <Link href="/sign-up">
              ...
              <>
                ...
                <Link href="/sign-in">
                  <Button variant="outline" className="border-[#222222] hover:bg-[#181818] text-white text-sm">
                    Sign Out
                  </Button>
                </Link>
              </>
      ...
      <section className="container mx-auto px-4 pt-20 pb-12 text-center relative z-10">
        <div className="mx-auto max-w-4xl space-y-6">
          ...
          <p className="mx-auto max-w-2xl text-base md:text-lg text-[#a8a8a8]">
            An API-first SaaS platform for appointments, electronic health records, billing, and automated patient workflows — powered by intelligent agent integrations.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            {!session ? (
              <Link href="/sign-up">
                <Button size="lg" className="bg-[#0007cd] text-white hover:bg-[#0005a3] border-none text-base px-6 h-12">
                  Get Started Free
            ...
            <Button size="lg" variant="secondary" className="bg-[#181818] border border-[#222222] text-white hover:bg-[#222222] text-base px-6 h-12">
        ...
        <div className="relative rounded-xl border border-[#222222] bg-[#000000] p-4 md:p-6 shadow-[0_0_50px_rgba(26,38,255,0.15)] overflow-hidden">
          ...
          <div className="flex items-center justify-between border-b border-[#222222] pb-3 mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="ml-2 font-mono text-xs text-[#888888]">clinic-agent-workspace</span>
            </div>
            ...
            <div className="rounded-lg border border-[#222222] bg-[#181818] p-4 font-mono text-xs text-[#a8a8a8] flex flex-col justify-between min-h-[160px]">
              <div>
                <div className="flex items-center justify-between text-[#888888] mb-2 border-b border-[#222222]/50 pb-1.5">
                  <span className="flex items-center gap-1.5"><Terminal className="h-3.5 w-3.5 text-[#00d4ff]" /> trigger_event.json</span>
...
{`{
  ...
  "datetime": "2026-07-02T18:00:00Z"
            ...
            <div className="rounded-lg border border-[#222222] bg-[#181818] p-4 font-mono text-xs text-[#a8a8a8] flex flex-col justify-between min-h-[160px]">
              <div>
                <div className="flex items-center justify-between text-[#888888] mb-2 border-b border-[#222222]/50 pb-1.5">
                  <span className="flex items-center gap-1.5"><Sparkles className="h-3.5 w-3.5 text-[#7b3aed]" /> clinic-copilot-ai</span>
                  <span className="text-[#00d4ff]">Processing</span>
                </div>
                <div className="space-y-1 text-white">
                  <p className="text-[#888888]">&gt; Fetching patient history...</p>
                  <p className="text-[#33d17a]">&gt; No medication conflicts detected.</p>
                  <p className="text-white font-medium">&gt; Recommended: ECG monitoring scheduled.</p>
                </div>
              </div>
              <div className="mt-2 text-[10px] text-[#888888] flex items-center gap-1 justify-end">
            ...
            <div className="rounded-lg border border-[#222222] bg-[#181818] p-4 font-mono text-xs text-[#a8a8a8] flex flex-col justify-between min-h-[160px]">
              <div>
                <div className="flex items-center justify-between text-[#888888] mb-2 border-b border-[#222222]/50 pb-1.5">
                  <span className="flex items-center gap-1.5"><Activity className="h-3.5 w-3.5 text-[#ff4d4d]" /> activity_stream.log</span>
                  <span className="text-[#33d17a]">Streaming</span>
                </div>
                <div className="space-y-1.5 text-[11px]">
                  <p className="text-[#888888]"><span className="text-white">[17:25:01]</span> Patient Pat_91823 check-in initiated</p>
                  <p className="text-[#888888]"><span className="text-white">[17:25:12]</span> Invoice INV-2901 generated successfully ($49.00)</p>
                  <p className="text-[#888888]"><span className="text-white">[17:25:22]</span> SMS dispatch queued via Twilio channel</p>
                </div>
              </div>
              <div className="mt-2 text-[10px] text-[#888888] flex items-center gap-1 justify-end">
            ...
            <div className="rounded-lg border border-[#222222] bg-[#181818] p-4 font-mono text-xs text-[#a8a8a8] flex flex-col justify-between min-h-[160px]">
              <div>
                <div className="flex items-center justify-between text-[#888888] mb-2 border-b border-[#222222]/50 pb-1.5">
                  <span className="flex items-center gap-1.5"><Cpu className="h-3.5 w-3.5 text-[#00d4ff]" /> active_integrations</span>
                  <span className="text-[#33d17a]">4 Connected</span>
                </div>
                <div className="grid grid-cols-2 gap-2 mt-1">
                  {integrations.map((item) => (
                    <div key={item.name} className="flex items-center gap-1.5 rounded bg-[#222222] p-1.5 border border-[#333333]">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[8px] text-[#888888] leading-none">{item.type}</p>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      <section className="container mx-auto px-4 py-24 relative z-10">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-[#a8a8a8] text-base md:text-lg">
            Powerful developer-first modules designed to run clinic operations with zero friction.
          </p>
        </div>
              ...
              <div>
                <div className="mb-6">
                  ...
                  <div className="mt-4 flex items-baseline gap-1">
                    ...
                    {plan.period && (
                      <span className="text-sm text-[#a8a8a8]">{plan.period}</span>
                    )}
                  </div>
                </div>
                <ul className="mb-8 space-y-3 border-t border-[#222222] pt-4">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-center gap-2 text-sm text-[#a8a8a8]">
      ...
      <footer className="border-t border-[#222222] bg-[#000000] py-12 relative z-10">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-sm text-[#888888]">
            © 2026 ClinicPro. All rights reserved. Built with the Composio Inspired Design System.
          </p>
