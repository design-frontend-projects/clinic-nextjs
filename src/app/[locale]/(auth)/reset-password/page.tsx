    ...
    <div className="flex min-h-screen items-center justify-center bg-canvas p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h2 className="text-xl font-medium tracking-tight text-foreground mt-2">ClinicPro</h2>
        </div>

        <Card className="rounded-xl">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-medium tracking-tight text-foreground">Reset password</CardTitle>
          ...
          <CardFooter className="flex justify-center text-sm text-muted-foreground border-t border-hairline-soft pt-4">
            ...
            <Link href="/sign-in" className="ms-1 text-accent-blue hover:underline font-medium">
              Sign in
            </Link>
          </CardFooter>
        </Card>
