    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0f0f0f] p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h2 className="text-xl font-medium tracking-tight text-white mt-2">ClinicPro</h2>
        </div>

        <Card className="bg-[#181818] border border-[#222222] shadow-[0_0_50px_rgba(26,38,255,0.08)] text-white rounded-xl">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-medium tracking-tight text-white">Create an account</CardTitle>
            <CardDescription className="text-sm text-[#a8a8a8]">Enter your details below to get started</CardDescription>
          </CardHeader>
          <CardContent>
            <SignUpForm />
          </CardContent>
